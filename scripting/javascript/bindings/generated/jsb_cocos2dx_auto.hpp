#ifndef __jsb_cocos2dx_h__
#define __jsb_cocos2dx_h__
...
JSBool js_cocos2dx_CCNode_setPositionZ(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCNode_getPositionZ(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCSprite_setPositionZ(JSContext *cx, uint32_t argc, jsval *vp);
