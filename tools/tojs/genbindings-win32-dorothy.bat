...
:: Generate bindings for dorothy
echo Generating bindings for dorothy...

python %CXX_GENERATOR_ROOT%/generator.py %TO_JS_ROOT%/dorothy.ini -s cocos2d-x -o %OUTPUT_DIR% -n jsb_dorothy_auto
