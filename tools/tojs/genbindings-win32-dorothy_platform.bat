...
set PYTHON_ROOT=D:/Dev/Python27
set NDK_ROOT=E:/Android/android-ndk-r8e
...
:: Generate bindings for dorothy platform
echo Generating bindings for dorothy platform...

python %CXX_GENERATOR_ROOT%/generator.py %TO_JS_ROOT%/dorothy_platform.ini -s cocos2d-x -o %OUTPUT_DIR% -n jsb_dorothy_platform_auto
