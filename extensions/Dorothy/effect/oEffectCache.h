...
public:
	...
	virtual void stop() = 0;
	virtual oEffect* setOffset(const CCPoint& pos) = 0;
...
public:
	...
	virtual void stop();
	virtual oEffect* setOffset( const CCPoint& pos );
...
class oEffectType: public CCObject
{
public:
	enum {None = -1, Particle = 0, Frame = 1};
	oEffectType(const char* filename, uint32 type);
