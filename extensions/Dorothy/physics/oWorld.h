...
public:
	...
	b2World* getB2World();
	/**
	 Iterations can affect Box2D`s CPU cost greatly.
	 Lower values to get better speed, high value to get better simulation.
	 Default are the minimum 1 and 1.
	 */
