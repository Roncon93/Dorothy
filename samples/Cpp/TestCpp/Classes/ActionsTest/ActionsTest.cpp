...
void ActionRotationalSkew::onEnter()
{
    ...
    CCRotateTo* actionToBack = CCRotateTo::create(2, 0);
    CCRotateBy* actionBy = CCRotateBy::create(2, 0.0f);
    CCRotateBy* actionBy2 = CCRotateBy::create(2, 45.0f);
...
void ActionRotationalSkewVSStandardSkew::onEnter()
{
    ...
    this->addChild(label);
    CCRotateBy* actionTo2 = CCRotateBy::create(2, 360);
    CCRotateBy* actionToBack2 = CCRotateBy::create(2, -360);
